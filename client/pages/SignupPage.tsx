    ...
    return (
      <div className="max-w-md justify-center items-center mx-auto mt-12 p-6 pr-20 bg-white rounded-lg shadow-xl border border-gray-200">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <button
            type="submit"
            className={`w-full ml-5 bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-lg focus:outline-none focus:shadow-outline transition duration-200 ease-in-out ${
        ...
        <p className="text-center ml-6 text-gray-600 text-sm mt-6">
